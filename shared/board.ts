...
// 실루엣 종류(pikachu/charizard/crystal/strawhat/tangerine/sudowoodo/skull/apple)는 다중 해상도 비트맵을
...
// 신규 6종 변형은 최대 해상도부터 나열해 정확 치수가 없을 때 variants[0]을 다운샘플한다.
// 피카츄 normal·hard 내부의 고립 빈칸 2개는 눈(구멍) — 경로 통로로도 기능. easy 는 해상도상 구멍 생략.
const SILHOUETTE_VARIANTS: Partial<Record<MaskKind, string[][]>> = {
  pikachu: [
    ...
    // normal 12×16 (102칸, 눈 구멍 2 + 우측 번개 꼬리)
    [
      "................",
      ".###.......##...",
      "..###.#######...",
    ...
    // hard 14×18 (150칸, 눈 구멍 2 — 대칭 귀·볼·발 분리 + 우측 번개 꼬리(상단 넓은 끝))
    [
      ".##.........##....",
      ".###.......###....",
      "..###.....###.....",
